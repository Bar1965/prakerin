...
// Ambil guru_id
$stmt = mysqli_prepare($conn, "SELECT id FROM instruktur WHERE user_id = ?");
...
<div class="page-header">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <a href="../../export/rekap_semua.php" target="_blank"
           style="display:inline-flex;align-items:center;gap:6px;padding:.5rem 1rem;background:#14532d;color:#fff;border-radius:8px;font-size:.85rem;font-weight:600;text-decoration:none;">
            🖨️ Export PDF Rekap Semua
        </a>
        <a href="rekap_excel.php" class="btn-primary-custom">
...
<div class="student-card">
    ...
    <div class="card-footer">
        <a href="detail_siswa.php?id=<?= $s['id'] ?>" class="btn-primary-custom btn-sm">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
            Lihat Detail
        </a>
        <a href="../../export/absensi.php?siswa_id=<?= $s['id'] ?>" target="_blank"
           class="btn-ghost-si btn-sm" style="background:#14532d;color:#fff;">
            🖨️ PDF Absensi
        </a>
        <a href="../../export/jurnal.php?siswa_id=<?= $s['id'] ?>" target="_blank"
           class="btn-ghost-si btn-sm" style="background:#374151;color:#fff;">
            📋 PDF Jurnal
        </a>
        <?php if ($s['no_hp']): ?>
        <a href="https://wa.me/<?= preg_replace('/^0/', '62', $s['no_hp']) ?>" target="_blank" class="btn-ghost-si btn-sm" style="background:#25D366;color:white;">
